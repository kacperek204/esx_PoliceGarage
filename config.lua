...
Config.CarGarageName = "Garaż LSPD"
...
Config.HeliGarageName = "Garaż helikopterów LSPD"
...
Config.BoatGarageName = "Garaż łódek LSPD"
...
Config.ExtraGarageName = "Dodatki do pojazdów"
...
Config.CarDraw3DText = "Naciśnij ~g~[E]~s~ aby ~y~Otworzyć garaż LSPD~s~"			-- set your desired text here
...
Config.HeliDraw3DText = "Naciśnij ~g~[E]~s~ aby ~y~Otworzyć garaż LSPD~s~"		-- set your desired text here
...
Config.BoatDraw3DText = "Naciśnij ~g~[E]~s~ aby ~y~Otworzyć garaż LSPD~s~"		-- set your desired text here
...
Config.ExtraDraw3DText = "Naciśnij ~g~[E]~s~ aby ~y~Otworzyć menu dodatków~s~"		-- set your desired text here
...
-- Menu Labels & Titles:
Config.LabelStoreVeh = "Schowaj pojazd"
Config.LabelGetVeh = "Weź pojazd"
Config.LabelPrimaryCol = " Kolor główny"
Config.LabelSecondaryCol = "Kolor drugi"
Config.LabelExtra = "Dodatki"
Config.LabelLivery = "Livery"
Config.TitlePoliceGarage = "Garaż policyjny"
Config.TitlePoliceExtra = "Dodatki"
Config.TitlePoliceLivery = "Livery"
Config.TitleColorType = "Typ koloru"
Config.TitleValues = "Value"

-- ESX.ShowNotifications:
Config.VehicleParked = "~b~Pojazd~s~ został zaparkowany!"
Config.NoVehicleNearby = "No ~b~Pojazd~s~ Wyciągnięty!"
Config.CarOutFromPolGar = "Wziąłeś ~b~Pojazd~s~ z ~y~Garażu policyjnego~s~!"
Config.HeliOutFromPolGar = "Wziąłeś ~b~Helikopter~s~ z ~y~Garażu policyjnego~s~!"
Config.BoatOutFromPolGar = "Wziąłeś ~b~Łódkę~s~ z ~y~Garażu policyjnego~s~!"
Config.VehRepNotify = "Twój ~b~pojazd~s~ is being ~y~repaired~s~, please wait!"
...
Config.VehicleLoadText = "Twój pojazd jest w drodze"			-- text on screen when vehicle model is being loaded
